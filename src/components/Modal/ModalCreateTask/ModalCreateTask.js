...
const ModalCreateTask = props => {
    ...
    const pickUpDelivery = (
        <div>
            {!addPickup ? (<Button onClick={handleAddPickup} block icon={<PlusOutlined />}>Add Pickup</Button>) :
                (
                    <Collapse>
            ...
            {!addDelivery ? (<Button onClick={handleAddDelivery} block icon={<PlusOutlined />}>Add Delivery</Button>)
                :
                (
                    <Collapse>
